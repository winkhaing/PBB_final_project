...
health_bar.for_each_trace(
    lambda t: t.update(name=t.name.split("_")[0])
)
...
# Update just the x-axis tick labels
health_time_series.update_xaxes(
    tickmode='array',
    tickvals=list(range(1995, 2011)),
    ticktext=[str(year) for year in range(1995, 2011)]
)
